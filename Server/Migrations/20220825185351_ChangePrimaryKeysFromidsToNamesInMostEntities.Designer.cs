...
namespace Server.Migrations
{
    ...
    [Migration("20220825185351_ChangePrimaryKeysFromidsToNamesInMostEntities")]
    partial class ChangePrimaryKeysFromidsToNamesInMostEntities
    {
            ...
            modelBuilder.Entity("EntityModels.Postgresql.ResourceNodeItem", b =>
                {
                    ...
                    b.Property<string>("ResourceNodeEventName")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.HasIndex("ResourceNodeEventName");
            ...
            modelBuilder.Entity("EntityModels.Postgresql.ResourceNodeItem", b =>
                {
                    ...
                    b.HasOne("EntityModels.Postgresql.ResourceNodeEvent", "ResourceNodeEvent")
                        ...
                        .HasForeignKey("ResourceNodeEventName")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
